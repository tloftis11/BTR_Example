...
// Daily briefing (stored, generated by cron)
export const getLatestBriefing   = ()        => api.get('/api/briefing/latest').then(r => r.data)
export const generateBriefing    = (filters) => api.post('/api/briefing/generate', { filters }).then(r => r.data)
