...
class Settings(BaseSettings):
    ...
    socrata_app_token: str = ""           # optional but raises rate limits
    pull_lookback_days: int = 90          # how far back each pipeline run fetches
    anomaly_window_weeks: int = 8         # baseline window for z-score
    anomaly_threshold: float = 2.0        # sigma threshold for alert
